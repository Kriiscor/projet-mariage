...
const Logement: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Hébergement - Hôtel L'Eterlou à Méribel"
        description="Réservez votre hébergement à l'Hôtel L'Eterlou pour notre mariage. Chambres de 1 à 5 personnes, piscine extérieure, sauna et hammam. Tarifs et informations de réservation."
      />
      <div className="min-h-screen py-8 sm:py-12 pb-24 bg-gradient-to-b from-white via-[#f8f5e6] to-[#e8e2c7] text-gray-800">
              ...
              <div className="space-y-4 text-sm sm:text-base">
                <div className="border-b pb-3">
                  ...
                  <p className="text-yellow-600">
                    ⭐ Particularité : Certaines chambres sont en soupente avec Velux. Pas de
                    balcon.
                  </p>
                </div>
                ...
                <div className="border-b pb-3">
                  ...
                  <p>
                    → Configuration personnalisable : Idéale pour les familles ou les petits
                    groupes.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6 bg-orange-50 p-3 sm:p-4 rounded-lg border border-orange-200 text-base sm:text-lg">
                  <div className="text-orange-800 text-center sm:text-left">
                    ...
                    <p className="text-sm sm:text-base">
                      ...
                      laquelle sera consigné le montant d'une nuit de votre réservation. Cette
                      caution sera libérée lors de votre départ de l'Hôtel.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-4 sm:p-6 rounded-md shadow-sm">
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-center mt-3 text-sm sm:text-base">
                    ...
                    <p>
                      Tel : <a href="tel:+33479088909">+33 4 79 08 89 00</a>
                    </p>
                    <p>
                      Lien du site web :{' '}
