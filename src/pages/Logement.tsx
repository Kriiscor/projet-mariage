...
const Logement: React.FC = () => {
  ...
  const carouselItems = [
    ...
    },
    {
      ...
      description: "Certaines disposent également d'un balcon privé. Chaque matin, un petit-déjeuner buffet est servi, et le restaurant propose des plats originaux et régionaux le soir."
    },
    {
      type: 'image' as const,
    ...
    {
      type: 'image' as const,
      content: './images/Exterieur-neige.png',
      alt: "L'Hôtel L'Eterlou sous la neige"
    }
  ];

  return (
    <div className="min-h-screen py-12 bg-gray-50 text-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Titre principal */}
        <h1 className="text-4xl text-center font-script text-gray-800 mb-6 mt-12 italic">Logement</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          ...
          <div className="lg:w-2/3 bg-white p-6 rounded-md shadow-sm">
            <h3 className="text-2xl font-semibold text-center mb-6">Hébergements - Mariage de Coralie et Ralph 💒</h3>
            
            <div className="space-y-4">
              <div className="border-b pb-3">
                <h4 className="font-bold">Chambre 1 Personne – 95 € par jour</h4>
                <p>→ Lit simple avec salle de douche</p>
                <p className="text-yellow-600">⭐ Particularité : Certaines chambres sont en soupente avec Velux. Pas de balcon.</p>
              </div>
              
              <div className="border-b pb-3">
                <h4 className="font-bold">Chambre 2 Personnes – 170 € par jour</h4>
                <p>→ Lit double avec salle de bain ou douche</p>
                <p className="text-yellow-600">⭐ Options : Possibilité de lits simples sur demande. Certaines chambres sont équipées d'un balcon, d'autres non. À préciser à la réservation.</p>
              </div>
              
              <div className="border-b pb-3">
                <h4 className="font-bold">Chambre 3 Personnes – 160 € par jour</h4>
                <p>→ Configuration personnalisable : Idéale pour les familles ou les petits groupes.</p>
              </div>
              ...
              <div className="pb-3">
                ...
                <p className="italic mt-2">Extras : Balcon | Certaines chambres en configuration sous combles sont en soupente.</p>
              </div>
            </div>
          </div>
