...
const Dabke: React.FC = () => {
  return (
    <div className="min-h-screen  bg-gradient-to-b from-white via-[#f8f5e6] to-[#e8e2c7] text-gray-800">
      {/* Header */}
      <div className="">
        {/* Hero Section */}
          ...
          <div className="mb-12 rounded-lg border bg-white p-4 sm:p-6  shadow-s">
            ...
            <div className="prose prose-lg max-w-none text-black">
              <p className="mb-4">
                ...
                origines remontent à des siècles, unit les danseurs dans une chaîne humaine rythmée
                qui symbolise la solidarité et l'appartenance communautaire.
              </p>
              <p className="mb-4">
                Traditionnellement exécutée lors des mariages, des festivals et des célébrations, la
                dabké varie selon les régions du Liban, chacune apportant ses propres pas et
