...
const RsvpPage: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="RSVP - Confirmez votre présence"
        description="Confirmez votre présence à notre mariage en remplissant le formulaire RSVP. Merci de nous répondre avant le 1er décembre 2025."
      />
      <div className="py-6 pb-24 bg-gradient-to-b from-white via-[#f8f5e6] to-[#e8e2c7] relative overflow-x-hidden">
