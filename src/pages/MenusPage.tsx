...
const MenusPage: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Menus - Mariage de Coralie et Ralph"
        description="Découvrez les menus de notre mariage : menu principal du samedi, menu du vendredi et menu du dimanche."
      />
      <div className="min-h-screen bg-[#f8f5e6] py-8 pb-24">
